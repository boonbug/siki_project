      ...
      <div class="row">
        ...
        <div class="col-md-6 d-md-block d-none">
            ...
            <a class="btn btn-danger d-flex align-items-center" href="#">
               <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('delete sCO cont. cargo') }} </a>
            <a class="btn btn-dark d-flex align-items-center" href="">
               <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('edit sCO cont. cargo') }} </a>
            <a class="btn btn-primary d-flex align-items-center" href="{{ route('SCOConventionalCargoCreate') }}">
               <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('add sCO cont. cargo') }} </a>
          </div>
      </div>
    </div>
  </div>
        ...
        <div class="card shadow-none solid-border height_equal">
          ...
          <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">Import Shore Handling - Bulk </h5>
                ...
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">Import Wharfage - Bulk</h5>
        ...
        <div class="card shadow-none solid-border height_equal">
          ...
          <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">Export Shore Handling - Bulk  </h5>
                    <h4 class="f-w-600">20 ft reffer</h4>
                        </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">Export Wharfage - Bulk </h5>
                    <h4 class="f-w-600">20ft</h4>
                    </div>
                </div>
                <div class="col-md-6">
