    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-6 d-md-block d-none">
          ...
          <a class="btn btn-danger d-flex align-items-center" href="{{ route('conventionalChargesCreate') }}">
             <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('delete conventional Charges') }} </a>
          <a class="btn btn-dark d-flex align-items-center" href="{{ route('conventionalChargesCreate') }}">
             <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('edit conventional Charges') }} </a>
          <a class="btn btn-primary d-flex align-items-center" href="{{ route('conventionalChargesCreate') }}">
             <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('add conventional Charges') }} </a>
        </div>
      </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-md-6">
                   ...
                   <h5 class="f-w-300">import shore handing:  </h5>
                    <h4 class="f-w-600">201 ft reffer</h4>
                        </div>
                </div>
                <div class="col-md-6">
                    <div class="card_box">
