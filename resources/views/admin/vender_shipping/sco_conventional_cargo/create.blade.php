                                ...
                                <div class="tab-content dark-field" id="container-details">
                                    <div class="tab-pane fade show active" id="wizard-info" role="tabpanel" aria-labelledby="wizard-info-tab">
                                        <div class="card-header pt-20">
                                            ...
                                            <a href="{{ route('SCOConventionalCargoView') }}" class="btn btn-primary float-end" style="margin-top:-35px;">SCO Conventional cargo</a>
                                        </div>
                                        <form class="theme-form row g-3 needs-validation custom-input" novalidate="">
                                            <div class="col-3">

                                                <select class="form-select" required="">
                                                    <option selected="" disabled="" value="">Import Shore Handling - Bulk</option>
                                                    <option>kPA </option>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <select class="form-select" required="">
                                                    <option selected="" disabled="" value="">Import Wharfage - Bulk</option>
                                                    <option>KPA </option>
                                                    <option>Shipping line </option>
                                                    <option>Transporter</option>
                                                    <option>CFS</option>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <select class="form-select" required="">
                                                    <option selected="" disabled="" value="">Northern Corridor Levy - Bulk</option>
                                                    <option>kPA </option>
                                                    <option>shipping line </option>
                                                    <option>transporter</option>
                                                    <option>CFS</option>
                                         ...
                                         <div class="col-3">
                                                <select class="form-select" required="">
                                                    <option selected="" disabled="" value="">Export Shore Handling - Bulk</option>
                                                    <option>KPA </option>
                                                    <option>Shipping line </option>
                                                    <option>Transporter</option>
                                                    <option>CFS</option>
                                         ...
                                         <div class="col-3">
                                                <select class="form-select" required="">
                                                    <option selected="" disabled="" value="">Export Wharfage - Bulk</option>
                                                    <option>KPA </option>
                                                    <option>Shipping line </option>
                                                    <option>Transporter</option>
                                                    <option>CFS</option>
                                            ...
                                            <div class="col-12">
                                                <button class="btn btn-primary" type="submit">Edit SCO Cargo</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
