...
@extends('master_setting.component.country')
    ...
    <div class="row page-title">
        ...
        <div class="col-sm-6">
            <div class="text-end col-12 col-sm-6 col-md-12">
                ...
                <button class="btn m-1 btn-primary" data-bs-toggle="modal" data-bs-target="#adddepartment" type="button" data-bs-toggle="tooltip" title="btn btn-info">Add New Country</button>
            </div>
        </div>
    </div>
</div>
