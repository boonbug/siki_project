                                ...
                                <div class="tab-content dark-field" id="container-details">
                                    <div class="tab-pane fade show active" id="wizard-info" role="tabpanel" aria-labelledby="wizard-info-tab">
                                        <div class="card-header pt-20">
                                            ...
                                            <a href="{{ route('SCOAdditionalDemmurageView') }}" class="btn btn-primary float-end" style="margin-top:-35px;">SCO Additional Demmurage</a>
                                        </div>
                                        <form class="theme-form row g-3 needs-validation custom-input" novalidate="">
                                            <div class="col-3">

                                                <select class="form-select" required="">
                                                    <option selected="" disabled="" value="">C11 Charges</option>
                                                    <option>kPA </option>
                                            ...
                                            <div class="col-3">
                                                <select class="form-select" required="">
                                                    <option selected="" disabled="" value="">Late Acceptance of Export cargo</option>
                                                    <option>KPA </option>
                                                    <option>Shipping line </option>
                                                    <option>Transporter</option>
                                                    <option>CFS</option>
                                            ...
                                            <div class="col-3">
                                                <select class="form-select" required="">
                                                    <option selected="" disabled="" value="">B/L Reprint Charges per page</option>
                                                    <option>kPA </option>
                                                    <option>shipping line </option>
                                                    <option>transporter</option>
                                                    <option>CFS</option>
                                            ...
                                            <div class="card-header pb-0">
                                                <h4>Demmurage details</h4>
                                            </div>
                                          <div class="col-3">
                                                <select class="form-select" required="">
                                                    <option selected="" disabled="" value="">Demurage Charges </option>
                                                    <option>kPA </option>
                                                    <option>shipping line </option>
                                                    <option>transporter</option>
                                                    <option>CFS</option>
                                             ...
                                             <div class="col-3">
                                                <select class="form-select" required="">
                                                    ...
                                                    <option>2 T0 5 </option>
                                                    <option>5 T0 7 </option>
                                                </select>
                                                <div class="invalid-feedback">Please select a valid work out.</div>
                                                <div class="valid-feedback">
                                                    Looks's Good! </div>
