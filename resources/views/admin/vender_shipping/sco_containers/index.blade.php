      ...
      <div class="row">
        ...
        <div class="col-md-6 d-md-block d-none">
            ...
            <a class="btn btn-danger d-flex align-items-center" href="#">
               <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('delete sCO containers') }} </a>
            <a class="btn btn-dark d-flex align-items-center" href="">
               <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('edit sCO containers') }} </a>
            <a class="btn btn-primary d-flex align-items-center" href="{{ route('SCOContainersCreate') }}">
               <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('add sCO containerse') }} </a>
          </div>
      </div>
    </div>
  </div>
        ...
        <div class="card shadow-none solid-border height_equal">
          ...
          <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">Delivery Order - Destination </h5>
                ...
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">Terminal Security - Destination </h5>
                ...
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">THC - Destination </h5>
                    <h4 class="f-w-600">20ft</h4>
                    </div>
                </div>
                 <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">Lift On / Off - Destination</h5>
                    <h4 class="f-w-600">20ft</h4>
                    </div>
                </div>
                 <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">Cleaning Charges - Destination </h5>
                    <h4 class="f-w-600">20ft</h4>
                    </div>
                </div>
                 <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">Admin Fee - Destination</h5>
                    <h4 class="f-w-600">20ft</h4>
                    </div>
                </div>
                 <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">Equipment Maintenance Fee</h5>
                    <h4 class="f-w-600">20ft</h4>
                    </div>
                </div>
                 <div class="col-md-6">
        ...
        <div class="card shadow-none solid-border height_equal">
          ...
          <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">B/L Issuance fees  </h5>
                    <h4 class="f-w-600">20 ft reffer</h4>
                        </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="card_box">
                   <h5 class="f-w-300">Telex Fees </h5>
                    <h4 class="f-w-600">20ft</h4>
                    </div>
                </div>
                <div class="col-md-6">
