                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 main-horizontal-header">
                                <div class="nav nav-pills horizontal-options" id="container-details" role="tablist" aria-orientation="vertical">
                                    <a class="nav-link active" id="bank-wizard-tab" data-bs-toggle="pill" href="#bank-wizard" role="tab" aria-controls="bank-wizard" aria-selected="false">
