...
@extends('master_setting.component.add_department')
@extends('master_setting.component.edit_department')
        ...
        <div class="row page-title">
            ...
            <div class="col-sm-6">
                <div class="text-end col-12 col-sm-6 col-md-12">
                        ...
                        <button class="btn m-1 btn-primary" data-bs-toggle="modal" data-bs-target="#adddepartment"  type="button" data-bs-toggle="tooltip" title="btn btn-info">Add New Department</button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-header pb-0">
                        <div class="dropdown icon-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown05"><a class="dropdown-item sweet-5" onclick="_gaq.push(['_trackEvent', 'example', 'try', 'sweet-5']);">Delete</a>
                                <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editdepartment">Edit</a></div>
                        </div>
                    </div>
