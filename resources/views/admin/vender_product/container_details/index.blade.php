    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-6 d-md-block d-none">
          ...
          <a class="btn btn-danger d-flex align-items-center" href="{{ route('containerDetailsCreate') }}">
             <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('delete container details') }} </a>
          <a class="btn btn-dark d-flex align-items-center" href="{{ route('containerDetailsCreate') }}">
             <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('edit container details') }} </a>
          <a class="btn btn-primary d-flex align-items-center" href="{{ route('containerDetailsCreate') }}">
             <i class="icofont icon-pencil"></i>&nbsp;{{ slugTitle('add container details') }} </a>
        </div>
      </div>
    </div>
</div>
